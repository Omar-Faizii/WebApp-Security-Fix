...
<div class="row" >
	...
	<div class="row-style-login-page-pannel">
		<div class="col-sm-9 col-xs-12">
                    <h2><b><u>SQL Injection Analysis</u></b></h2>
			<h4>The objective of this Project is to provide a detailed analysis of the SQL injection attack conducted as part of a information security learning project. </h4>
