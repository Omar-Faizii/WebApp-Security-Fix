<?php
session_start();
$con=mysqli_connect("localhost","root","password","ecommerce1") or die(mysqli_error($con));

// Vulnerable code: using user input directly in the SQL query
$sql="SELECT * FROM products";
$result=mysqli_query($con,$sql);
if($result===false){
    echo "<h1>There is no products database available</h1>";
}
        ...
        <div class=" col-md-4 col-sm-6 col-xs-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<center><img  class="img-responsive" src="images\phones\<?php echo$row['name']; ?>.jpg" width="215">
                                            <b> <?= $row['name'] ?><br><br></b>
                                            <b>Price:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rs&nbsp;&nbsp;<?= $row['price'] ?>/-<br><br></b></center>
                                        <b>specifications</b>
                                        <p>Brand &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apple<br>
                                           Operating &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;iOS<br>
